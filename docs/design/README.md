...
|----|-------|--------|------|--------|------|
| DESIGN-0001 | Claude Code Skills for Nix Config Management | Draft | 2026-04-11 | Donald Gifford | [0001-claude-code-skills-for-nix-config-management.md](0001-claude-code-skills-for-nix-config-management.md) |
