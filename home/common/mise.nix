...

{
  programs.mise = {
    ...
    # Global tools live in config/mise/conf.d/global.toml (symlinked via
    # configs.nix) so renovate can manage version pins via annotations.
    # Settings stay here since they're not version-tracked.
    globalConfig = {
      settings = {
